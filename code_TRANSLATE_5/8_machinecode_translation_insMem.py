...
machine_code = open('9_ins_mem.mif','w')
...
#     print(i)
#     machine_code.write(i+'\n')

for i in range(255,-1,-1):
    if (i<len(decoded_code)):
        print ("    "+str(i)+" :   "+decoded_code[i]+";")
        machine_code.write("    "+str(i)+" :   "+decoded_code[i]+";"+'\n')
    else:
        print ("    "+str(i)+" :   "+ "XXXXXXXX"+";")
        machine_code.write("    "+str(i)+" :   "+ "XXXXXXXX"+";"+"\n")
